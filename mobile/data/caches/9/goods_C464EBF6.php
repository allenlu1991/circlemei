...
<meta charset="utf-8" />
<title>清华大学POLO衫_POLO衫_清华大学_圈美-专属圈子的服装潮牌 触屏版</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=清华大学POLO衫&pic=images/201503/source_img/128_G_1427405468387.jpg"> 分享 </a> </div>
</header>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(128)" style="display: inline;"></a>
  <div class="title">
    <h1> 清华大学POLO衫 </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">￥<span>100</span></b>　    <del>￥<span>120</span></del> 
    </li>
    ...
    <form action="javascript:addToCart(128)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields"   style="display: block;">	 
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(128)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(128);">
