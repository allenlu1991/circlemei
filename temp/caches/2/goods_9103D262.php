...
<meta name="Description" content="柔滑轻盈的慕斯乳霜质地，紧致并维护肤质，可消除浮肿，提升面部轮廓！" />
<title>娇韵诗超V型纤容紧致瘦脸面膜75ml_面膜_面部护理_护肤_圈美-专属圈子的服装品牌</title>
...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=6">护肤</a> <code>&gt;</code> <a href="category.php?id=7">面部护理</a> <code>&gt;</code> <a href="category.php?id=20">面膜</a> <code>&gt;</code> 娇韵诗超V型纤容紧致瘦脸面膜75ml </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="娇韵诗超V型纤容紧致瘦脸面膜75ml">  <a href="images/200905/goods_img/17_P_1241969394354.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=17'); return false;"><img id="J_prodImg" src="images/201311/goods_img/17_G_1384994573565.jpg" alt="娇韵诗超V型纤容紧致瘦脸面膜75ml" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/200905/goods_img/17_P_1241969394354.jpg" rel="zoom-id: Zoomer" rev="images/200905/goods_img/17_P_1241969394354.jpg"><img src="images/200905/thumb_img/17_thumb_P_1241969394537.jpg" alt="娇韵诗超V型纤容紧致瘦脸面膜75ml"></a> </li>
                            <li > <a href="images/201311/goods_img/17_P_1384994573474.jpg" rel="zoom-id: Zoomer" rev="images/201311/goods_img/17_P_1384994573474.jpg"><img src="images/201311/thumb_img/17_thumb_P_1384994573411.jpg" alt="娇韵诗超V型纤容紧致瘦脸面膜75ml"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(17)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>娇韵诗超V型纤容紧致瘦脸面膜75ml</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  本店价<font  id="ECS_SHOPPRICE">275.00</font> </b>
                  <p style="display:none" > 
                     
                    注册用户：<font  id="ECS_RANKPRICE_1">￥<span>275</span></font> 
                     
                    vip：<font  id="ECS_RANKPRICE_2">￥<span>261</span></font> 
                     
                    微信用户：<font  id="ECS_RANKPRICE_99">￥<span>275</span></font> 
              ...
              <div class="center_txt clearfix"> 
                ...
                <strong style="float:left; width:60px; font-size: 13px;color: #999; font-weight:normal; padding-top:10px;">颜色：</strong>
                      ...
                      <a style=" text-decoration:none" class="cattsel" onclick="changeAtt(this)" href="javascript:;" name="201" title="[ ￥<span>0.00</span>]">黑色                      <input style="display:none" id="spec_value_201" type="radio" name="spec_185" value="201" checked /></a> 
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"> <a href="javascript:addToCartShowDiv(17)"></a> </div>
                  <div class="center_collect_btn"> <a href="javascript:collect(17)">收藏该商品</a> </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 17); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 17); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),17); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),17); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
...
return offset;
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>商品名称</td>
                        <td><p class="fit_people "> 娇韵诗超V型纤容紧致瘦脸面膜75ml</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201311/goods_img/17_G_1384994573565.jpg" alt="娇韵诗超V型纤容紧致瘦脸面膜75ml"  /></td>
                      </tr>
                        ...
                        <td><p class="fit_people ">2.8英寸</p></td>
                                            ...
                                            <tr >
                        <td>手机制式</td>
                        <td><p class="fit_people ">CDMA</p></td>
                      </tr>
                                            <tr >
                        <td>理论通话时间</td>
                        <td><p class="fit_people ">8小时</p></td>
                      </tr>
                                            <tr >
                        <td>理论待机时间</td>
              ...
              <div class="inLeft_title " id="miqsp">
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201311/thumb_img/17_thumb_G_1384994573595.gif" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>购买过娇韵诗超V型纤容紧致瘦脸面膜75ml的顾客，在收到商品才可以对该商品发表评论</div> 
              ...
              <div class="comment_body " >
                ...
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:17;}554fcae493e564ee0dc75bdf2ebf94ca</div>
