...
<title>索爱原装M2卡读卡器_护肤套装_护肤_圈美-专属圈子的服装品牌</title>
...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=6">护肤</a> <code>&gt;</code> <a href="category.php?id=11">护肤套装</a> <code>&gt;</code> 索爱原装M2卡读卡器 </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="索爱原装M2卡读卡器">  <a href="images/200905/goods_img/5_P_1241422518168.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=5'); return false;"><img id="J_prodImg" src="images/200905/goods_img/5_G_1241422518773.jpg" alt="索爱原装M2卡读卡器" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/200905/goods_img/5_P_1241422518168.jpg" rel="zoom-id: Zoomer" rev="images/200905/goods_img/5_P_1241422518168.jpg"><img src="images/200905/thumb_img/5_thumb_P_1241422518416.jpg" alt="索爱原装M2卡读卡器"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(5)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>索爱原装M2卡读卡器</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                   ...
                   <a href="group_buy.php?act=view&amp;id=13" title="团购活动 索爱原装M2卡读卡器的时间为2013-11-20到2031-11-24，赶快来抢吧！" style="font-weight:100; color:#FF4560;">索爱原装M2卡读卡器</a> <br/> 
                  ...
                  <p style="display:none" > 商品点击数：21 </p>
                  <p> 
                  ...
                  本店价<font  id="ECS_SHOPPRICE">20.00</font> </b>
                  <p style="display:none" > 
                     
                    注册用户：<font  id="ECS_RANKPRICE_1">￥<span>20</span></font> 
                     
                    vip：<font  id="ECS_RANKPRICE_2">￥<span>19</span></font> 
                     
                    微信用户：<font  id="ECS_RANKPRICE_99">￥<span>20</span></font> 
              ...
              <div class="center_txt clearfix"> 
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"> <a href="javascript:addToCartShowDiv(5)"></a> </div>
                  <div class="center_collect_btn"> <a href="javascript:collect(5)">收藏该商品</a> </div>
...
<script>
	...
	with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?cdnversion='+~(-new Date()/36e5)];
            ...
            <div class="detail_logo">
              <div class="detail_logo_img"> <a target="_blank" href="brand.php?id=7"><img src="data/brandlogo/1385070660861937745.jpg" border="0" width="180" height="100" alt="倩碧"></a> </div>
              <div class="detail_logo_txt">
                <p>倩碧</p>
              </div>
              <div class="detail_logo_btn"> <a href="brand.php?id=7" >进入品牌专柜</a> </div>
            </div>
          </form>
        </div>
      </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 5); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 5); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),5); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),5); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
...
return offset;
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>商品名称</td>
                        <td><p class="fit_people "> 索爱原装M2卡读卡器</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/200905/goods_img/5_G_1241422518773.jpg" alt="索爱原装M2卡读卡器"  /></td>
                      </tr>
              ...
              <div class="inLeft_title " id="miqsp">
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/200905/thumb_img/5_thumb_G_1241422518886.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>购买过索爱原装M2卡读卡器的顾客，在收到商品才可以对该商品发表评论</div> 
              ...
              <div class="comment_body " >
                ...
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:5;}554fcae493e564ee0dc75bdf2ebf94ca</div>
