...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">彩妆</a> <code>&gt;</code> <a href="category.php?id=4">眼部彩妆</a> <code>&gt;</code> <a href="category.php?id=49">睫毛</a> <code>&gt;</code> 思亲肤90度卷长睫毛膏10g </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="思亲肤90度卷长睫毛膏10g">  <a href="images/200905/goods_img/10_P_1242973436620.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=10'); return false;"><img id="J_prodImg" src="images/201311/goods_img/10_G_1385076352496.jpg" alt="思亲肤90度卷长睫毛膏10g" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/200905/goods_img/10_P_1242973436620.jpg" rel="zoom-id: Zoomer" rev="images/200905/goods_img/10_P_1242973436620.jpg"><img src="images/200905/thumb_img/10_thumb_P_1242973436219.jpg" alt="思亲肤90度卷长睫毛膏10g"></a> </li>
                            <li > <a href="images/201311/goods_img/10_P_1385076352266.png" rel="zoom-id: Zoomer" rev="images/201311/goods_img/10_P_1385076352266.png"><img src="images/201311/thumb_img/10_thumb_P_1385076352398.jpg" alt="思亲肤90度卷长睫毛膏10g"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(10)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>思亲肤90度卷长睫毛膏10g</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p style="display:none" > 商品点击数：34 </p>
                  <p> 
                  ...
                  本店价<font  id="ECS_SHOPPRICE">49.90</font> </b>
                  <p style="display:none" > 
                     
                    注册用户：<font  id="ECS_RANKPRICE_1">￥<span>50</span></font> 
                     
                    vip：<font  id="ECS_RANKPRICE_2">￥<span>47</span></font> 
                     
                    微信用户：<font  id="ECS_RANKPRICE_99">￥<span>50</span></font> 
              ...
              <div class="center_txt clearfix"> 
                ...
                <strong style="float:left; width:60px; font-size: 13px;color: #999; font-weight:normal; padding-top:10px;">颜色：</strong>
                      ...
                      <a style=" text-decoration:none" class="cattsel" onclick="changeAtt(this)" href="javascript:;" name="239" title="[ ￥<span>0.00</span>]">黑色                      <input style="display:none" id="spec_value_239" type="radio" name="spec_185" value="239" checked /></a> 
                      
                       
                       
                      <a style=" text-decoration:none"  onclick="changeAtt(this)" href="javascript:;" name="240" title="[ ￥<span>0.00</span>]">白色                      <input style="display:none" id="spec_value_240" type="radio" name="spec_185" value="240"  /></a> 
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"> <a href="javascript:addToCartShowDiv(10)"></a> </div>
                  <div class="center_collect_btn"> <a href="javascript:collect(10)">收藏该商品</a> </div>
...
<script>
	...
	with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?cdnversion='+~(-new Date()/36e5)];
            ...
            <div class="detail_logo">
              <div class="detail_logo_img"> <a target="_blank" href="brand.php?id=24"><img src="data/brandlogo/1385076375210486006.jpg" border="0" width="180" height="100" alt="思亲肤"></a> </div>
              <div class="detail_logo_txt">
                <p>思亲肤</p>
              </div>
              <div class="detail_logo_btn"> <a href="brand.php?id=24" >进入品牌专柜</a> </div>
            </div>
          </form>
        </div>
      </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 10); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 10); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),10); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),10); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>商品名称</td>
                        <td><p class="fit_people "> 思亲肤90度卷长睫毛膏10g</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201311/goods_img/10_G_1385076352496.jpg" alt="思亲肤90度卷长睫毛膏10g"  /></td>
                      </tr>
                      
                       
                                            <tr >
                        <td>上市日期</td>
                        <td><p class="fit_people ">2008年05月</p></td>
                      </tr>
                                            <tr >
                        <td>屏幕大小</td>
                        <td><p class="fit_people ">2.2英寸</p></td>
                      </tr>
                                            <tr >
                        <td>手机制式</td>
              ...
              <div class="inLeft_attributes inLeft_style">
                <div class="inLeft_orderDetail" >
                  <div class="inLeft_orderDetail_in" > <p>C702可以说是一种在外观上复古的产物，不仅延续T系列早期的直板造型，而且在屏幕和键盘的组合分布上都继承了前辈的精髓。C702的机身尺寸为106&times;48&times;15.5毫米，重量为105克。此外索尼爱立信为C702融入了<font size="3" color="#ff0000"><strong>三防特性，即防尘、防滑和防水溅</strong></font>，这款新的C702搭载了索尼爱立信经典A200平台，界面布局与W908c、K858c一致，典型的特征就是配备左右软键、中央确定键和通话/挂机键。</p>
...
<p>&nbsp;</p> </div>
              ...
              <div class="inLeft_title " id="miqsp">
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201311/thumb_img/10_thumb_G_1385076352897.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>购买过思亲肤90度卷长睫毛膏10g的顾客，在收到商品才可以对该商品发表评论</div> 
              ...
              <div class="comment_body " >
                ...
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:10;}554fcae493e564ee0dc75bdf2ebf94ca</div>
