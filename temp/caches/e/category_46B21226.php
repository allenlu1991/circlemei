...
<title>BB霜_面部彩妆_彩妆_圈美-专属圈子的服装品牌</title>
  ...
  <div class="searchBody block"> 
    ...
    <div class="search_title ">
      <div class="title_left">
        <div id="ur_here"> 
		<span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">彩妆</a> <code>&gt;</code> <a href="category.php?id=5">面部彩妆</a> <code>&gt;</code> <a href="category.php?id=51">BB霜</a>         </div>
      </div>
...
<div class="search_rightChoseAll clearfix  ">
  ...
  <div class="searchRight_brand "> 
      ...
      <ul class="show_box" style=" height:60px; overflow:hidden; position:relative;">
                ...
                <li><a href="category.php?id=51&amp;brand=22&amp;price_min=99&amp;price_max=100">谜尚</a></li>
      ...
      <ul class="show_box"  style="width:750px;">
                ...
                <li><a href="category.php?id=51&amp;price_min=0&amp;price_max=0">全部</a></li>
         
         
                <li><span>99&nbsp;-&nbsp;100</span></li>
...
<div class="searchRight_title">
  <div class="rightTitle_left"> <a name='goods_list'></a>
    <form method="GET" class="sort" name="listform">
      <div class="f_l"> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('list')"><img src="themes/miqinew/images/display_mode_list.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('grid')"><img src="themes/miqinew/images/display_mode_grid_act.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('text')"><img src="themes/miqinew/images/display_mode_text.gif" alt=""></a> <a  href="category.php?category=51&display=grid&brand=0&price_min=99&price_max=100&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img style="margin-left:0px" src="themes/miqinew/images/goods_id_DESC.gif" alt="按上架时间排序"></a> 
        
       <a href="category.php?category=51&display=grid&brand=0&price_min=99&price_max=100&filter_attr=0&page=1&sort=sales_volume&order=DESC#goods_list"><img style="margin-left:0px"  src="themes/miqinew/images/sales_default.gif" alt="按销量排序"></a>
         <a href="category.php?category=51&display=grid&brand=0&price_min=99&price_max=100&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/miqinew/images/shop_price_default.gif" alt="按价格排序"></a> 
         <a href="category.php?category=51&display=grid&brand=0&price_min=99&price_max=100&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/miqinew/images/last_update_default.gif" alt="按更新时间排序"></a> </div>
      
      <input type="hidden" name="category" value="51" />
      <input type="hidden" name="display" value="grid" id="display" />
      <input type="hidden" name="brand" value="0" />
      <input type="hidden" name="price_min" value="99" />
...
<form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
    ...
    <ul class="y_searchList clearfix" >
      ...
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=14"><img src="images/201311/thumb_img/14_thumb_G_1385076093787.jpg" alt="谜尚红色BB霜21#50ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=14" title="谜尚红色BB霜21#50ml">谜尚红色BB霜21#50ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>99</span></font> 
           
           
          <font class="market_s">￥<span>208</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(14,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(14);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_14_best">
      </div>
      </li>
...
>&nbsp;&nbsp;Licensed</a><br />
        <div align="left"  id="rss"><a href="feed.php?cat=51"><img src="themes/miqinew/images/xml_rss2.gif" alt="rss" /></a></div>
  </div>
</div>
