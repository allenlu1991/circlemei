...
<div class="block box">
 <div id="ur_here">
  <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> 碧欧泉 </div>
</div>
<div class="blank"></div>
      ...
      <div class="boxCenterList">
        ...
        <tr>
          ...
          <div style="width:200px; overflow:hidden;">
                      <img src="data/brandlogo/1385072323411408978.jpg" />
                      </div>
          </td>
          <td bgcolor="#ffffff">
          <br />
            ...
            <div class="brandCategoryA">
                          ...
                          <a href="brand.php?id=18&amp;cat=19" class="f6">洁面 (1)</a>
                          <a href="brand.php?id=18&amp;cat=42" class="f6">保湿 (1)</a>
                          <a href="brand.php?id=18&amp;cat=85" class="f6">碧欧泉 (1)</a>
                          </div>  
         </td>
        </tr>
      </table>
...
<div class="searchRight_title">
  <div class="rightTitle_left"> <a name='goods_list'></a>
    <form method="GET" class="sort" name="listform">
      <div class="f_l"> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('list')"><img src="themes/miqinew/images/display_mode_list.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('grid')"><img src="themes/miqinew/images/display_mode_grid_act.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('text')"><img src="themes/miqinew/images/display_mode_text.gif" alt=""></a> <a  href="brand.php?category=0&display=grid&brand=18&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=ASC#goods_list"><img style="margin-left:0px" src="themes/miqinew/images/goods_id_DESC.gif" alt="按上架时间排序"></a> 
        
       <a href="brand.php?category=0&display=grid&brand=18&price_min=&price_max=&filter_attr=&page=1&sort=sales_volume&order=DESC#goods_list"><img style="margin-left:0px"  src="themes/miqinew/images/sales_default.gif" alt="按销量排序"></a>
         <a href="brand.php?category=0&display=grid&brand=18&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/miqinew/images/shop_price_default.gif" alt="按价格排序"></a> 
         <a href="brand.php?category=0&display=grid&brand=18&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/miqinew/images/last_update_default.gif" alt="按更新时间排序"></a> </div>
  ...
  <div class="rightTitle_right">
    ...
    <ul class="y_searchList clearfix" >
      ...
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=80"><img src="images/201311/thumb_img/80_thumb_G_1385662269065.jpg" alt="碧欧泉活泉爽肤洁面乳150ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=80" title="">碧欧泉活泉爽肤洁面乳150ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>169</span></font> 
        ...
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(80,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(80);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_80_best">
      </div>
      </li>
      ...
      <li  class="li"  >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=70"><img src="images/201311/thumb_img/70_thumb_G_1385080063413.jpg" alt="碧欧泉男士温泉保湿露75ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=70" title="">碧欧泉男士温泉保湿露75ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>235</span></font> 
           
           
          <font class="market_s">￥<span>450</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(70,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(70);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_70_best">
      </div>
      </li>
      ...
      <li  class="li"  >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=45"><img src="images/201311/thumb_img/45_thumb_G_1385072303507.jpg" alt="碧欧泉温泉至臻保湿精华露30ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=45" title="">碧欧泉温泉至臻保湿精华露30ml</a></p>
        <p class="y_price"> 
          ...
          <font class="market_s">￥<span>530</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(45,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(45);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_45_best">
      </div>
      </li>
...
>&nbsp;&nbsp;Licensed</a><br />
        <div align="left"  id="rss"><a href="feed.php?brand=18"><img src="themes/miqinew/images/xml_rss2.gif" alt="rss" /></a></div>
  </div>
</div>
