...
<title>凯文克莱BE中性香水200ml_中性香水_香氛_圈美-专属圈子的服装品牌</title>
...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=16">香氛</a> <code>&gt;</code> <a href="category.php?id=88">中性香水</a> <code>&gt;</code> 凯文克莱BE中性香水200ml </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="凯文克莱BE中性香水200ml">  <a href="images/201311/goods_img/57_P_1385077699351.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=57'); return false;"><img id="J_prodImg" src="images/201311/goods_img/57_G_1385077699964.jpg" alt="凯文克莱BE中性香水200ml" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/201311/goods_img/57_P_1385077699351.jpg" rel="zoom-id: Zoomer" rev="images/201311/goods_img/57_P_1385077699351.jpg"><img src="images/201311/thumb_img/57_thumb_P_1385077699763.jpg" alt="凯文克莱BE中性香水200ml"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(57)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>凯文克莱BE中性香水200ml</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                  ...
                  <p style="display:none" > 商品点击数：17 </p>
                  <p> 
                  ...
                  <p>节&nbsp;&nbsp;&nbsp;省：¥311（4.5折）</p>
                  <p>已售出： <span style="color: #4c4c4c;">2件</span></p>
              ...
              <div class="center_txt clearfix"> 
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"> <a href="javascript:addToCartShowDiv(57)"></a> </div>
                  <div class="center_collect_btn"> <a href="javascript:collect(57)">收藏该商品</a> </div>
...
<script>
	...
	with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?cdnversion='+~(-new Date()/36e5)];
            ...
            <div class="detail_logo">
              <div class="detail_logo_img"> <a target="_blank" href="brand.php?id=31"><img src="data/brandlogo/1385077748974263151.jpg" border="0" width="180" height="100" alt="凯文克莱"></a> </div>
              <div class="detail_logo_txt">
                <p>凯文克莱</p>
              </div>
              <div class="detail_logo_btn"> <a href="brand.php?id=31" >进入品牌专柜</a> </div>
            </div>
          </form>
        </div>
      </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 57); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 57); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),57); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),57); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
...
return offset;
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>商品名称</td>
                        <td><p class="fit_people "> 凯文克莱BE中性香水200ml</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201311/goods_img/57_G_1385077699964.jpg" alt="凯文克莱BE中性香水200ml"  /></td>
                      </tr>
              ...
              <div class="inLeft_title " id="miqsp">
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201311/thumb_img/57_thumb_G_1385077699842.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>购买过凯文克莱BE中性香水200ml的顾客，在收到商品才可以对该商品发表评论</div> 
