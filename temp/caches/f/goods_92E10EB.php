...
<a class="t" href="category.php?id=60">浓密卷翘</a>
                    ...
                    <li  class="current"><a href="category.php?id=5" >眼部彩妆</a>
          <div class='sub_nav'>
<dl>
<dd>
...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">彩妆</a> <code>&gt;</code> <a href="category.php?id=4">眼部彩妆</a> <code>&gt;</code> <a href="category.php?id=47">眼线</a> <code>&gt;</code> 蜜丝佛陀纤柔眼线液1#0.75ml </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="蜜丝佛陀纤柔眼线液1#0.75ml">  <a href="images/200905/goods_img/21_P_1242109298519.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=21'); return false;"><img id="J_prodImg" src="images/201311/goods_img/21_G_1385075715772.jpg" alt="蜜丝佛陀纤柔眼线液1#0.75ml" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/200905/goods_img/21_P_1242109298519.jpg" rel="zoom-id: Zoomer" rev="images/200905/goods_img/21_P_1242109298519.jpg"><img src="images/200905/thumb_img/21_thumb_P_1242109298525.jpg" alt="蜜丝佛陀纤柔眼线液1#0.75ml"></a> </li>
                            <li > <a href="images/201311/goods_img/21_P_1385075715200.png" rel="zoom-id: Zoomer" rev="images/201311/goods_img/21_P_1385075715200.png"><img src="images/201311/thumb_img/21_thumb_P_1385075715191.jpg" alt="蜜丝佛陀纤柔眼线液1#0.75ml"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(21)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>蜜丝佛陀纤柔眼线液1#0.75ml</a></div>
            <div class="detail_center">
              <div class="center_txt">
                <div class="center_text"> 
                   ...
                   <a href="group_buy.php?act=view&amp;id=10" title="团购活动 金立 A30的时间为2013-11-20到2030-11-24，赶快来抢吧！" style="font-weight:100; color:#FF4560;">金立 A30</a> <br/> 
                  ...
                  <p style="display:none" > 商品点击数：26 </p>
                  <p> 
                  ...
                  本店价<font  id="ECS_SHOPPRICE">75.00</font> </b>
                  <p style="display:none" > 
                     
                    注册用户：<font  id="ECS_RANKPRICE_1">￥<span>75</span></font> 
                     
                    vip：<font  id="ECS_RANKPRICE_2">￥<span>71</span></font> 
                     
                    微信用户：<font  id="ECS_RANKPRICE_99">￥<span>75</span></font> 
              ...
              <div class="center_txt clearfix"> 
                ...
                <strong style="float:left; width:60px; font-size: 13px;color: #999; font-weight:normal; padding-top:10px;">颜色：</strong>
                      ...
                      <a style=" text-decoration:none" class="cattsel" onclick="changeAtt(this)" href="javascript:;" name="188" title="[ ￥<span>0.00</span>]">黑色                      <input style="display:none" id="spec_value_188" type="radio" name="spec_185" value="188" checked /></a> 
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"> <a href="javascript:addToCartShowDiv(21)"></a> </div>
                  <div class="center_collect_btn"> <a href="javascript:collect(21)">收藏该商品</a> </div>
...
<script>
	...
	with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?cdnversion='+~(-new Date()/36e5)];
            ...
            <div class="detail_logo">
              <div class="detail_logo_img"> <a target="_blank" href="brand.php?id=10"><img src="data/brandlogo/1385075742122482555.jpg" border="0" width="180" height="100" alt="蜜丝佛陀"></a> </div>
              <div class="detail_logo_txt">
                <p>蜜丝佛陀</p>
              </div>
              <div class="detail_logo_btn"> <a href="brand.php?id=10" >进入品牌专柜</a> </div>
            </div>
          </form>
        </div>
      </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 21); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 21); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),21); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),21); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>商品名称</td>
                        <td><p class="fit_people "> 蜜丝佛陀纤柔眼线液1#0.75ml</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201311/goods_img/21_G_1385075715772.jpg" alt="蜜丝佛陀纤柔眼线液1#0.75ml"  /></td>
                      </tr>
                      
                       
                                            <tr >
                        <td>存储卡格式</td>
                        <td><p class="fit_people ">T-Flash</p></td>
                      </tr>
                                            <tr >
                        <td>理论通话时间</td>
                        <td><p class="fit_people ">2.5小时</p></td>
                                            ...
                                            <tr >
                        <td>理论待机时间</td>
                        <td><p class="fit_people ">100小时</p></td>
                      </tr>
...
<p><span style="font-size: medium;"><font size="3">提醒 以上性能均为本公司员工试机后所写,产品资料仅供参考,请以收到实物为准</font></span></p> </div>
                </div>
              </div>
              ...
              <div class="inLeft_title " id="miqsp">
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201311/thumb_img/21_thumb_G_1385075715191.jpg" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>购买过蜜丝佛陀纤柔眼线液1#0.75ml的顾客，在收到商品才可以对该商品发表评论</div> 
              ...
              <div class="comment_body " >
                ...
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:21;}554fcae493e564ee0dc75bdf2ebf94ca</div>
