<?php exit;?>a:3:{s:8:"template";a:8:{i:0;s:59:"/a/domains/circlemei.com/circlemei/themes/miqinew/brand.dwt";i:1;s:73:"/a/domains/circlemei.com/circlemei/themes/miqinew/library/page_header.lbi";i:2;s:69:"/a/domains/circlemei.com/circlemei/themes/miqinew/library/ur_here.lbi";i:3;s:75:"/a/domains/circlemei.com/circlemei/themes/miqinew/library/category_tree.lbi";i:4;s:69:"/a/domains/circlemei.com/circlemei/themes/miqinew/library/history.lbi";i:5;s:72:"/a/domains/circlemei.com/circlemei/themes/miqinew/library/goods_list.lbi";i:6;s:67:"/a/domains/circlemei.com/circlemei/themes/miqinew/library/pages.lbi";i:7;s:73:"/a/domains/circlemei.com/circlemei/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1429656407;s:8:"maketime";i:1429652807;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div class="block box">
 <div id="ur_here">
  <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> 雅顿 </div>
</div>
<div class="blank"></div>
      ...
      <div class="boxCenterList">
        ...
        <tr>
          ...
          <div style="width:200px; overflow:hidden;">
                      <img src="data/brandlogo/1385071484398955050.jpg" />
                      </div>
          </td>
          <td bgcolor="#ffffff">
          <br />
            ...
            <div class="brandCategoryA">
                          <a href="brand.php?id=13" class="f6">所有分类 </a>
                          <a href="brand.php?id=13&amp;cat=19" class="f6">洁面 (1)</a>
                          <a href="brand.php?id=13&amp;cat=24" class="f6">化妆水 (1)</a>
                          <a href="brand.php?id=13&amp;cat=33" class="f6">护唇 (1)</a>
                          <a href="brand.php?id=13&amp;cat=104" class="f6">淡香 (1)</a>
                          </div>  
         </td>
        </tr>
      </table>
...
<div class="searchRight_title">
  <div class="rightTitle_left"> <a name='goods_list'></a>
    <form method="GET" class="sort" name="listform">
      <div class="f_l"> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('list')"><img src="themes/miqinew/images/display_mode_list.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('grid')"><img src="themes/miqinew/images/display_mode_grid_act.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('text')"><img src="themes/miqinew/images/display_mode_text.gif" alt=""></a> <a  href="brand.php?category=0&display=grid&brand=13&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=ASC#goods_list"><img style="margin-left:0px" src="themes/miqinew/images/goods_id_DESC.gif" alt="按上架时间排序"></a> 
        
       <a href="brand.php?category=0&display=grid&brand=13&price_min=&price_max=&filter_attr=&page=1&sort=sales_volume&order=DESC#goods_list"><img style="margin-left:0px"  src="themes/miqinew/images/sales_default.gif" alt="按销量排序"></a>
         <a href="brand.php?category=0&display=grid&brand=13&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/miqinew/images/shop_price_default.gif" alt="按价格排序"></a> 
         <a href="brand.php?category=0&display=grid&brand=13&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/miqinew/images/last_update_default.gif" alt="按更新时间排序"></a> </div>
  ...
  <div class="rightTitle_right">
    ...
    <ul class="y_searchList clearfix" >
      ...
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=79"><img src="images/201311/thumb_img/79_thumb_G_1385660900460.jpg" alt="雅顿2合1洗面奶150ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=79" title="">雅顿2合1洗面奶150ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>75</span></font> 
           
           
          <font class="market_s">￥<span>150</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(79,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(79);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_79_best">
      </div>
      </li>
      ...
      <li  class="li"  >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=54"><img src="images/201311/thumb_img/54_thumb_G_1385077336588.jpg" alt="雅顿第五大道香水30ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=54" title="">雅顿第五大道香水30ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>109</span></font> 
           
           
          <font class="market_s">￥<span>280</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(54,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(54);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_54_best">
      </div>
      </li>
      ...
      <li  class="li"  >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=40"><img src="images/201311/thumb_img/40_thumb_G_1385071423191.jpg" alt="雅顿8小时经典润泽护唇啫喱15ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=40" title="">雅顿8小时经典润泽护唇啫喱15ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>79</span></font> 
        ...
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(40,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(40);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_40_best">
      </div>
      </li>
      ...
      style='margin: 0 0px 18px 0;' 
       >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=12"><img src="images/201311/thumb_img/12_thumb_G_1384995644320.jpg" alt="雅顿保湿调理露200ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=12" title="">雅顿保湿调理露200ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>78</span></font> 
           
           
          <font class="market_s">￥<span>200</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(12,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(12);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_12_best">
      </div>
      </li>
...
>&nbsp;&nbsp;Licensed</a><br />
        <div align="left"  id="rss"><a href="feed.php?brand=13"><img src="themes/miqinew/images/xml_rss2.gif" alt="rss" /></a></div>
  </div>
</div>
