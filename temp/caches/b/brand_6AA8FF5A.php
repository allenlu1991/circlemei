...
<div class="block box">
 <div id="ur_here">
  <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> 倩碧 </div>
</div>
<div class="blank"></div>
      ...
      <div class="boxCenterList">
        ...
        <tr>
          ...
          <div style="width:200px; overflow:hidden;">
                      <img src="data/brandlogo/1385070660861937745.jpg" />
                      </div>
          </td>
          <td bgcolor="#ffffff">
          <br />
            ...
            <div class="brandCategoryA">
                          ...
                          <a href="brand.php?id=7&amp;cat=11" class="f6">护肤套装 (1)</a>
                          <a href="brand.php?id=7&amp;cat=19" class="f6">洁面 (1)</a>
                          <a href="brand.php?id=7&amp;cat=30" class="f6">去眼纹 (1)</a>
                          <a href="brand.php?id=7&amp;cat=67" class="f6">洁面 (1)</a>
                          </div>  
         </td>
        </tr>
      </table>
...
<div class="searchRight_title">
  <div class="rightTitle_left"> <a name='goods_list'></a>
    <form method="GET" class="sort" name="listform">
      <div class="f_l"> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('list')"><img src="themes/miqinew/images/display_mode_list.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('grid')"><img src="themes/miqinew/images/display_mode_grid_act.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('text')"><img src="themes/miqinew/images/display_mode_text.gif" alt=""></a> <a  href="brand.php?category=0&display=grid&brand=7&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=ASC#goods_list"><img style="margin-left:0px" src="themes/miqinew/images/goods_id_DESC.gif" alt="按上架时间排序"></a> 
        
       <a href="brand.php?category=0&display=grid&brand=7&price_min=&price_max=&filter_attr=&page=1&sort=sales_volume&order=DESC#goods_list"><img style="margin-left:0px"  src="themes/miqinew/images/sales_default.gif" alt="按销量排序"></a>
         <a href="brand.php?category=0&display=grid&brand=7&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/miqinew/images/shop_price_default.gif" alt="按价格排序"></a> 
         <a href="brand.php?category=0&display=grid&brand=7&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/miqinew/images/last_update_default.gif" alt="按更新时间排序"></a> </div>
  ...
  <div class="rightTitle_right">
    ...
    <ul class="y_searchList clearfix" >
      ...
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=82"><img src="images/201311/thumb_img/82_thumb_G_1385662403961.jpg" alt="倩碧液体洁面皂加强型200ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=82" title="">倩碧液体洁面皂加强型200ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>159</span></font> 
        ...
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(82,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(82);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_82_best">
      </div>
      </li>
      ...
      <li  class="li"  >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=78"><img src="images/201311/thumb_img/78_thumb_G_1385080829383.jpg" alt="倩碧男士洁面乳（加强型）150ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=78" title="">倩碧男士洁面乳（加强型）150ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>155</span></font> 
           
           
          <font class="market_s">￥<span>220</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(78,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(78);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_78_best">
      </div>
      </li>
      ...
      <li  class="li"  >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=38"><img src="images/201311/thumb_img/38_thumb_G_1385071125679.jpg" alt="倩碧全效眼部护理精华露15ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=38" title="">倩碧全效眼部护理精华露15ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>219</span></font> 
           
           
          <font class="market_s">￥<span>390</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(38,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(38);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_38_best">
      </div>
      </li>
      ...
      style='margin: 0 0px 18px 0;' 
       >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=5"><img src="images/200905/thumb_img/5_thumb_G_1241422518886.jpg" alt="索爱原装M2卡读卡器"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=5" title="">索爱原装M2卡读卡器</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>20</span></font> 
           
           
          <font class="market_s">￥<span>24</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(5,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(5);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_5_best">
      </div>
      </li>
...
>&nbsp;&nbsp;Licensed</a><br />
        <div align="left"  id="rss"><a href="feed.php?brand=7"><img src="themes/miqinew/images/xml_rss2.gif" alt="rss" /></a></div>
  </div>
</div>
