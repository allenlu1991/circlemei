...
<div class="search_rightChoseAll clearfix  ">
  ...
  <div class="searchRight_brand "> 
      ...
      <ul class="show_box" style=" height:60px; overflow:hidden; position:relative;">
                ...
                <li><a href="category.php?id=25&amp;price_min=0&amp;price_max=0">全部</a></li>
      ...
      <ul class="show_box"  style="width:750px;">
                ...
                <li><a href="category.php?id=25&amp;brand=14&amp;price_min=470&amp;price_max=480">470&nbsp;-&nbsp;480</a></li>
...
<div class="searchRight_title">
  <div class="rightTitle_left"> <a name='goods_list'></a>
    <form method="GET" class="sort" name="listform">
      <div class="f_l"> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('list')"><img src="themes/miqinew/images/display_mode_list.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('grid')"><img src="themes/miqinew/images/display_mode_grid_act.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('text')"><img src="themes/miqinew/images/display_mode_text.gif" alt=""></a> <a  href="category.php?category=25&display=grid&brand=14&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><img style="margin-left:0px" src="themes/miqinew/images/goods_id_ASC.gif" alt="按上架时间排序"></a> 
        
       <a href="category.php?category=25&display=grid&brand=14&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume&order=DESC#goods_list"><img style="margin-left:0px"  src="themes/miqinew/images/sales_default.gif" alt="按销量排序"></a>
         <a href="category.php?category=25&display=grid&brand=14&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/miqinew/images/shop_price_default.gif" alt="按价格排序"></a> 
         <a href="category.php?category=25&display=grid&brand=14&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/miqinew/images/last_update_default.gif" alt="按更新时间排序"></a> </div>
