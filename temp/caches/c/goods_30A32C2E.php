...
<div class="content_title">
  <div class="block">
    <div id="ur_here"> <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">彩妆</a> <code>&gt;</code> <a href="category.php?id=3">彩妆套装</a> <code>&gt;</code> 娇兰金钻修颜粉饼SPF10 </div>
  </div>
</div>
<div class="content_detailed">
  ...
  <div id="detail_main_img" class="imgbox">
    <div class="layout_wrap">
      <div class="prodimg"  title="娇兰金钻修颜粉饼SPF10">  <a href="images/200905/goods_img/22_P_1241971076061.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: on; zoom-distance: 22;zoom-width: 450; zoom-height: 450;" onclick="window.open('gallery.php?id=22'); return false;"><img id="J_prodImg" src="images/201311/goods_img/22_G_1384994678394.jpg" alt="娇兰金钻修颜粉饼SPF10" /></a></div>
      <div class="tabbox clearfix">
        <div id="detail_img_slider" class="imgtab">
          <div class="imgtab_clip" id="J_tabSlider">
            <ul class="imgtab_con">
               
                            <li class="cur"> <a href="images/200905/goods_img/22_P_1241971076061.jpg" rel="zoom-id: Zoomer" rev="images/200905/goods_img/22_P_1241971076061.jpg"><img src="images/200905/thumb_img/22_thumb_P_1241971076595.jpg" alt="娇兰金钻修颜粉饼SPF10"></a> </li>
                            <li > <a href="images/201311/goods_img/22_P_1384994678624.jpg" rel="zoom-id: Zoomer" rev="images/201311/goods_img/22_P_1384994678624.jpg"><img src="images/201311/thumb_img/22_thumb_P_1384994678264.jpg" alt="娇兰金钻修颜粉饼SPF10"></a> </li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(22)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="center_title"><a>娇兰金钻修颜粉饼SPF10</a></div>
            <div class="detail_center">
              ...
              <div class="center_txt clearfix"> 
                ...
                <strong style="float:left; width:60px; font-size: 13px;color: #999; font-weight:normal; padding-top:10px;">颜色：</strong>
                      ...
                      <a style=" text-decoration:none" class="cattsel" onclick="changeAtt(this)" href="javascript:;" name="182" title="[ ￥<span>0.00</span>]">黑色                      <input style="display:none" id="spec_value_182" type="radio" name="spec_185" value="182" checked /></a> 
                ...
                <div class="center_btn">
                  <div class="center_shop_btn"> <a href="javascript:addToCartShowDiv(22)"></a> </div>
                  <div class="center_collect_btn"> <a href="javascript:collect(22)">收藏该商品</a> </div>
...
<script>
	...
	with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?cdnversion='+~(-new Date()/36e5)];
            ...
            <div class="detail_logo">
              <div class="detail_logo_img"> <a target="_blank" href="brand.php?id=12"><img src="data/brandlogo/1385071326106067039.jpg" border="0" width="180" height="100" alt="娇兰"></a> </div>
              <div class="detail_logo_txt">
                <p>娇兰</p>
              </div>
              <div class="detail_logo_btn"> <a href="brand.php?id=12" >进入品牌专柜</a> </div>
            </div>
          </form>
        </div>
      </div>
...
jQuery(function($){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 22); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 22); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),22); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),22); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
            ...
            <div  id="no_try_record"> 
                ...
                <div class="inLeft_attributes_1">
                  <table border="0" cellspacing="0" cellpadding="0" >
                    <tbody>
                      <tr>
                        <td>商品名称</td>
                        <td><p class="fit_people "> 娇兰金钻修颜粉饼SPF10</p></td>
                        <td align="center" style="text-align:center;" rowspan="9"><img src="images/201311/goods_img/22_G_1384994678394.jpg" alt="娇兰金钻修颜粉饼SPF10"  /></td>
                      </tr>
                      
                       
                                            <tr >
                        <td>上市日期</td>
                        <td><p class="fit_people ">2008年12月</p></td>
                      </tr>
                                            <tr >
                        <td>存储卡格式</td>
                        <td><p class="fit_people ">microSD</p></td>
                      </tr>
                                            <tr >
                        <td>内存容量</td>
                        <td><p class="fit_people ">288MB</p></td>
                      </tr>
                                            <tr >
                        <td>手机制式</td>
                        <td><p class="fit_people ">GSM,850,900,1800,1900</p></td>
                                            ...
                                            <tr >
                        <td>理论通话时间</td>
                        <td><p class="fit_people ">6.5小时</p></td>
                      </tr>
                                            <tr >
                        <td>理论待机时间</td>
                        <td><p class="fit_people ">450小时</p></td>
                      </tr>
                                            <tr >
                        <td>外观样式</td>
              ...
              <div class="inLeft_attributes inLeft_style">
                <div class="inLeft_orderDetail" >
                  <div class="inLeft_orderDetail_in" > <p><img src="http://xgone.xgou.com/xgoumanage/upload/20090325/2009032502045081100887.jpg" alt="" /></p>
<p>&nbsp;</p>
...
<p>&nbsp;</p> </div>
              ...
              <div class="inLeft_title " id="miqsp">
                ...
                <div class="rate"> <strong>100.0%</strong> <br> 好评度 </div>
                <div class="percent"> 
                  <dl> 
                    <dt>好评</dt> 
                    <dd class="d1"> 
                ...
                <div class="actor"> 
                 <a href=""> <img src="images/201311/thumb_img/22_thumb_G_1384994678955.gif" alt="" style="width:100px;height:100px;"></a>
                </div> 
                <div class="btns"> 
                  <div>购买过娇兰金钻修颜粉饼SPF10的顾客，在收到商品才可以对该商品发表评论</div> 
              ...
              <div class="comment_body " >
                ...
                <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:22;}554fcae493e564ee0dc75bdf2ebf94ca</div>
