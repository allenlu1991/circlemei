...
<div class="block box">
 <div id="ur_here">
  <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> 娇兰 </div>
</div>
<div class="blank"></div>
      ...
      <div class="boxCenterList">
        ...
        <tr>
          ...
          <div style="width:200px; overflow:hidden;">
                      <img src="data/brandlogo/1385071326106067039.jpg" />
                      </div>
          </td>
          <td bgcolor="#ffffff">
          <br />
            ...
            <div class="brandCategoryA">
                          ...
                          <a href="brand.php?id=12&amp;cat=3" class="f6">彩妆套装 (1)</a>
                          <a href="brand.php?id=12&amp;cat=19" class="f6">洁面 (1)</a>
                          <a href="brand.php?id=12&amp;cat=23" class="f6">精华 (1)</a>
                          <a href="brand.php?id=12&amp;cat=86" class="f6">女士香水 (1)</a>
                          </div>  
         </td>
        </tr>
      </table>
...
<div class="searchRight_title">
  <div class="rightTitle_left"> <a name='goods_list'></a>
    <form method="GET" class="sort" name="listform">
      <div class="f_l"> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('list')"><img src="themes/miqinew/images/display_mode_list.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('grid')"><img src="themes/miqinew/images/display_mode_grid_act.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('text')"><img src="themes/miqinew/images/display_mode_text.gif" alt=""></a> <a  href="brand.php?category=0&display=grid&brand=12&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=ASC#goods_list"><img style="margin-left:0px" src="themes/miqinew/images/goods_id_DESC.gif" alt="按上架时间排序"></a> 
        
       <a href="brand.php?category=0&display=grid&brand=12&price_min=&price_max=&filter_attr=&page=1&sort=sales_volume&order=DESC#goods_list"><img style="margin-left:0px"  src="themes/miqinew/images/sales_default.gif" alt="按销量排序"></a>
         <a href="brand.php?category=0&display=grid&brand=12&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/miqinew/images/shop_price_default.gif" alt="按价格排序"></a> 
         <a href="brand.php?category=0&display=grid&brand=12&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/miqinew/images/last_update_default.gif" alt="按更新时间排序"></a> </div>
  ...
  <div class="rightTitle_right">
    ...
    <ul class="y_searchList clearfix" >
      ...
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=89"><img src="images/201311/thumb_img/89_thumb_G_1385663017724.jpg" alt="娇兰纯净奥秘莲花洁面慕丝150ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=89" title="">娇兰纯净奥秘莲花洁面慕丝150ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>279</span></font> 
           
           
          <font class="market_s">￥<span>430</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(89,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(89);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_89_best">
      </div>
      </li>
      ...
      <li  class="li"  >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=48"><img src="images/201311/thumb_img/48_thumb_G_1385076661630.jpg" alt="娇兰小黑裙女士淡香水50ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=48" title="">娇兰小黑裙女士淡香水50ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>459</span></font> 
           
           
          <font class="market_s">￥<span>730</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(48,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(48);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_48_best">
      </div>
      </li>
      ...
      <li  class="li"  >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=39"><img src="images/201311/thumb_img/39_thumb_G_1385071299149.jpg" alt="娇兰水合青春活能精华露50ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=39" title="">娇兰水合青春活能精华露50ml</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>869</span></font> 
           
           
          <font class="market_s">￥<span>1750</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(39,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(39);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_39_best">
      </div>
      </li>
      ...
      style='margin: 0 0px 18px 0;' 
       >
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=22"><img src="images/201311/thumb_img/22_thumb_G_1384994678955.gif" alt="娇兰金钻修颜粉饼SPF10"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=22" title="">娇兰金钻修颜粉饼SPF10</a></p>
        <p class="y_price"> 
          
           
          <font class="">￥<span>399</span></font> 
           
           
          <font class="market_s">￥<span>750</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(22,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(22);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_22_best">
      </div>
      </li>
...
>&nbsp;&nbsp;Licensed</a><br />
        <div align="left"  id="rss"><a href="feed.php?brand=12"><img src="themes/miqinew/images/xml_rss2.gif" alt="rss" /></a></div>
  </div>
</div>
