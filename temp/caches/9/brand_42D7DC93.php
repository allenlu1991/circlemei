...
<div class="block box">
 <div id="ur_here">
  <span>当前位置:</span> <a href=".">首页</a> <code>&gt;</code> 欧树 </div>
</div>
<div class="blank"></div>
      ...
      <div class="boxCenterList">
        ...
        <tr>
          ...
          <div style="width:200px; overflow:hidden;">
                      <img src="data/brandlogo/1385662855656952777.jpg" />
                      </div>
          </td>
          <td bgcolor="#ffffff">
          <br />
            ...
            <div class="brandCategoryA">
                          <a href="brand.php?id=44" class="f6">所有分类 </a>
                          <a href="brand.php?id=44&amp;cat=19" class="f6">洁面 (1)</a>
                          </div>  
         </td>
        </tr>
      </table>
...
<div class="searchRight_title">
  <div class="rightTitle_left"> <a name='goods_list'></a>
    <form method="GET" class="sort" name="listform">
      <div class="f_l"> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('list')"><img src="themes/miqinew/images/display_mode_list.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('grid')"><img src="themes/miqinew/images/display_mode_grid_act.gif" alt=""></a> <a href="javascript:;" style="display:none;" onClick="javascript:display_mode('text')"><img src="themes/miqinew/images/display_mode_text.gif" alt=""></a> <a  href="brand.php?category=0&display=grid&brand=44&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=ASC#goods_list"><img style="margin-left:0px" src="themes/miqinew/images/goods_id_DESC.gif" alt="按上架时间排序"></a> 
        
       <a href="brand.php?category=0&display=grid&brand=44&price_min=&price_max=&filter_attr=&page=1&sort=sales_volume&order=DESC#goods_list"><img style="margin-left:0px"  src="themes/miqinew/images/sales_default.gif" alt="按销量排序"></a>
         <a href="brand.php?category=0&display=grid&brand=44&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/miqinew/images/shop_price_default.gif" alt="按价格排序"></a> 
         <a href="brand.php?category=0&display=grid&brand=44&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/miqinew/images/last_update_default.gif" alt="按更新时间排序"></a> </div>
  ...
  <div class="rightTitle_right">
    ...
    <ul class="y_searchList clearfix" >
      ...
      <div class="item clearfix">
        <Div class="p_img"> <a href="goods.php?id=87"><img src="images/201311/thumb_img/87_thumb_G_1385662805914.jpg" alt="欧树蜂蜜洁面凝胶400ml"  width="220" height="220"/></a> </Div>
        <p class="y_proName"><a href="goods.php?id=87" title="">欧树蜂蜜洁面凝胶400ml</a></p>
        <p class="y_price"> 
          ...
          <font class="market_s">￥<span>240</span></font> 
           
        </p>
		
        <div class="y_hide">
          <p class="y_addCart"> <a  href="javascript:addToCartShowDiv(87,1,'best')"  class="join_cart">加入购物袋</a> </p>
          <div class="y_userOpera">
            <p class="y_collectLeft"> <a href="javascript:collect(87);" class="y_collect"> <span class="y_collectIcon"></span>收藏宝贝 </a> </p>
          </div>
        </div>
        <div class="sucess_joinCart" id="addtocartdialog_retui_87_best">
      </div>
      </li>
...
>&nbsp;&nbsp;Licensed</a><br />
        <div align="left"  id="rss"><a href="feed.php?brand=44"><img src="themes/miqinew/images/xml_rss2.gif" alt="rss" /></a></div>
  </div>
</div>
